...
<body>
  ...
  <form action="" method="post">
    <div class="col-12 row justify-content-center">
      ...
      <button class="col-2 btn btn-primary">Volgende</button>
  </div>
...
<div class="col-12 row justify-content-center">
    ...
    <button type="button" class="col-2 btn btn-primary mr-3">Previous</button>
    <button type="button" class="col-2 btn btn-primary">Next</button>
  </div>
  ...
  <!--Tweede keuze liedje en artiest-->
    ...
    <div class="row col-12 beves">
      <button type="button" class="col-3 btn btn-primary sendDesign">Send</button>
    </div>
